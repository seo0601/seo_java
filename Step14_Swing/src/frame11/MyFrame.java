...
public class MyFrame extends JFrame implements ActionListener{
   ...
   public MyFrame() {
      ...
      //버튼에 리스너 등록하기, 등록을 하게 되면 밑에 오버라이드 메소드에서 사용할 수 있다.
      plusBtn.addActionListener(this); //this는 MyFrame의 참조값이다
   ...
   public static void main(String[] args) {
	...
	public void actionPerformed(ActionEvent e) {
   		...
   		//2. 어떤 버튼을 눌럿는지 알아내서 적절한 연산을 해 결과를 얻어낸다.
   		String command = e.getActionCommand(); // +,-,*,/ 중 하나가 들어 온다.
   		
   		//연산의 결과를 담을 지역 변수를 미리 만들어 놓는다.
   		double result = 0;
   		if(command.equals("+")) {
   			result = num1 + num2;
   		...
   		label_result.setText(resultNum);
   			...
   			//Exception이 일어나면 실행의 흐름이 여기서 멈추게 된다.확인을 누르기 전까지 다른 작업이 불가능
   			//쓰레드를 사용하면 여러 작업을 할 수 있다.
   			JOptionPane.showMessageDialog(this, "숫자 형식으로 입력해 주세요");
   			tf_num1.setText(""); //""를 쓰면 썼던 글자가 지워짐
   			tf_num2.setText("");
   		}
   	}
}